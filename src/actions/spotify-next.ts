...
import { preflight, getPlayer, play, pause, runOAuth, next } from "../core/spotify-core";

const ACTION_UUID = "com.gilgamesh.spotify-actions.next";

@action({ UUID: ACTION_UUID })
export class SpotifyNext extends SingletonAction<any> {
    /**
